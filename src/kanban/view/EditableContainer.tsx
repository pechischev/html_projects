...
interface IEditableContainerProps extends IMemoryStorage {
    item: BaseItem;
}

export class EditableContainer extends MemoryStorage<IEditableContainerProps, IEditableContainerState> {
    ...
    private _titleElement(): any {
        return (
            <div className="title form-control-sm"
                 onClick={this._toggleEditableState.bind(this)}>{this.state.title}</div>
        );
    }
}